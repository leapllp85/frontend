...
<body>
  ...
  return (
    ...
    >
      ...
      <VStack align="start" gap={6} h="full" p={6} position="relative">
        {/* Header */}
        <Box w="full">
          <HStack gap={3} mb={2}>
            <Box 
            ...
            <VStack align="start" gap={0}>
              <Heading size="xl" color="gray.800" fontWeight="black" letterSpacing="tight">
                AI Assistant
              </Heading>
        ...
        {userQuestion && (
          ...
          >
            <Card.Header p={6} pb={4}>
              <HStack gap={3}>
                <Avatar.Root size="md" bg="whiteAlpha.200" color="white">
                  <Avatar.Fallback>

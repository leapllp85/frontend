...
import { Expand, Filter, MoreHorizontal } from "lucide-react";
import { organizationHeader } from "./organizationInfoData";
import { colors } from "@/types/styles";

export function OrganizationInfoHeader() {
  const HeaderIcon = organizationHeader.icon;
    ...
    >
      <HStack gap="18px" align="center" minW={0}>
        <Box
          ...
          flexShrink={0}
        >
          <HeaderIcon size={25} strokeWidth={2.1} />
        </Box>
      ...
      <HStack gap={{ base: "10px", md: "12px" }} flexShrink={0}>
        ...
        >
          <HStack gap="10px">
            <Expand size={16} color={colors.secondaryText} />

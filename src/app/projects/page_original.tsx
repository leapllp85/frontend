    ...
    return (
        <AppLayout>
            <Box w="full" h="100vh" bg="gray.50" overflow="auto">
                {/* Content */}
                <Box px={{ base: 3, sm: 4, md: 6, lg: 8, xl: 10 }} py={{ base: 3, sm: 4, md: 5, lg: 6 }} maxW="1920px" mx="auto">
                    <VStack gap={6} align="stretch" w="full">
                    {/* Stats Cards */}
                    {!loading && !error && (
                    <SimpleGrid columns={{ base: 1, sm: 2, md: 2, lg: 3, xl: 3 }} gap={{ base: 3, sm: 4, lg: 4 }}>
                        <Card.Root bg="white" borderRadius="lg" border="1px solid" borderColor="gray.200">
                            <Card.Body p={5}>
                                <HStack justify="space-between">
                                    <VStack align="start" gap={1}>
                                        <Text fontSize="0.875rem" color="gray.600" fontWeight="500">Total Projects</Text>
                                        <Text fontSize="1.875rem" fontWeight="700" color="gray.900">{totalCount}</Text>
                                    </VStack>
                        ...
                        <Card.Root bg="white" borderRadius="lg" border="1px solid" borderColor="gray.200">
                            <Card.Body p={5}>
                                <HStack justify="space-between">
                                    <VStack align="start" gap={1}>
                                        <Text fontSize="0.875rem" color="gray.600" fontWeight="500">Active</Text>
                                        <Text fontSize="1.875rem" fontWeight="700" color="green.600">{projects.filter(p => p.status === 'Active').length}</Text>
                                    </VStack>
                        ...
                        <Card.Root bg="white" borderRadius="lg" border="1px solid" borderColor="gray.200">
                            <Card.Body p={5}>
                                <HStack justify="space-between">
                                    <VStack align="start" gap={1}>
                                        <Text fontSize="0.875rem" color="gray.600" fontWeight="500">High Priority</Text>
                                        <Text fontSize="1.875rem" fontWeight="700" color="red.600">{projects.filter(p => p.criticality === 'High').length}</Text>
                                    </VStack>
                    ...
                    {!loading && !error && (
                        <HStack gap={4} flexWrap="wrap" flexDirection={{ base: 'column', md: 'row' }}>
                            <Box position="relative" flex={1} minW={{ base: 'full', md: '300px' }} w={{ base: 'full', md: 'auto' }}>
                                <Input
                                            ...
                                            <Table.Row bg="linear-gradient(to bottom, #e5e7eb 0%, #d1d5db 100%)" borderBottom="2px solid" borderColor="gray.300">
                                                <Table.ColumnHeader p={3} fontWeight="600" color="gray.800" verticalAlign="top">
                                                    <VStack align="start" gap={2} h="70px">
                                                        <Text fontSize="0.875rem">Business Unit</Text>
                                                        <Input
                                                            size="sm"
                                                            placeholder="Filter..."
                                                ...
                                                <Table.ColumnHeader p={3} fontWeight="600" color="gray.800" verticalAlign="top">
                                                    <Box h="70px" display="flex" alignItems="start">
                                                        <Text fontSize="0.875rem">Project Name</Text>
                                                    </Box>
                                                </Table.ColumnHeader>
                                                ...
                                                <Table.ColumnHeader p={3} fontWeight="600" color="gray.800" verticalAlign="top">
                                                    <VStack align="start" gap={2} h="70px">
                                                        <Text fontSize="0.875rem">Criticality</Text>
                                                        <select
                                                ...
                                                <Table.ColumnHeader p={3} fontWeight="600" color="gray.800" verticalAlign="top">
                                                    <Box h="70px" display="flex" alignItems="start">
                                                        <Text fontSize="0.875rem">Timeline</Text>
                                                    </Box>
                                                </Table.ColumnHeader>
                                                <Table.ColumnHeader p={3} fontWeight="600" color="gray.800" verticalAlign="top">
                                                    <Box h="70px" display="flex" alignItems="start">
                                                        <Text fontSize="0.875rem">Contributors</Text>
                                                    </Box>
                                                </Table.ColumnHeader>
                                                <Table.ColumnHeader p={3} fontWeight="600" color="gray.800" verticalAlign="top">
                                                    <VStack align="start" gap={2} h="70px">
                                                        <Text fontSize="0.875rem">Status</Text>
                                                        <select
                                                ...
                                                <Table.ColumnHeader p={3} fontWeight="600" color="gray.800" textAlign="center" verticalAlign="top">
                                                    <Box h="70px" display="flex" alignItems="start" justifyContent="center">
                                                        <Text fontSize="0.875rem">Actions</Text>
                                                    </Box>
                                                </Table.ColumnHeader>
                                            </Table.Row>
                                        </Table.Header>
